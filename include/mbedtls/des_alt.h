 ...
 * @file des_alt.h
 *
 * @brief Uses the hardware implementation of DES cryptography on the stm32f4 on the ARMEBS4 board
 *
 * @author Dayer Yannick
 */
#ifndef POLARSSL_DES_ALT_H
#define POLARSSL_DES_ALT_H
...
#define DES_KEY_SIZE    8	/* MUST be 8 */
